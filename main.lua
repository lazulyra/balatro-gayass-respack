...
SMODS.Atlas { key = "cards_2", path = "8BitDeck_opt2-gayass_respack.png", px = 71, py = 95, prefix_config = false }
...
SMODS.Atlas { key = "Centers", path = "Enhancers-gayass_respack.png", px = 71, py = 95, prefix_config = false }
